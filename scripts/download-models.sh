#!/usr/bin/env bash
# mosaic-compass: Pre-deploy job to download BGE-small embedding weights into the
# persistent volume. Runs once per Porter deploy, before the web service starts.
